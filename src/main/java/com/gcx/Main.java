...
public class Main {
    ...
    // EXTENDED options - see https://github.com/greycortex/VIP/
    ...
    // Path to file that will be filled with ready SQL queries containing database update data
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (cmd.hasOption(UPDATE)) { // run quick update
                NVDobject.quickUpdate(update_cve_cpe_file, update_output_file);
            }
