...
CREATE TABLE mitre.cpe_compl_cpe (
    ...
    cpe_cpe_id character varying(255) NOT NULL
);
...
CREATE TABLE mitre.cve_descriptions (
    cve_cve_id character varying(255) NOT NULL,
...
--
-- Name: cve_descriptions fk4cuth8nqb3m4jbfne2bu7t3ck; Type: FK CONSTRAINT; Schema: mitre; Owner: postgres
--

ALTER TABLE ONLY mitre.cve_descriptions
    ADD CONSTRAINT fk4cuth8nqb3m4jbfne2bu7t3ck FOREIGN KEY (cve_cve_id) REFERENCES mitre.cve(cve_id);
...
ALTER TABLE ONLY mitre.node
    ADD CONSTRAINT fke0epthqcjyip4jsr131x83k78 FOREIGN KEY (cve_cve_id) REFERENCES mitre.cve(cve_id);
...
--
-- Name: cpe_compl_cpe fkg2x25bry80snr0sstvpde05cp; Type: FK CONSTRAINT; Schema: mitre; Owner: postgres
--

ALTER TABLE ONLY mitre.cpe_compl_cpe
    ADD CONSTRAINT fkg2x25bry80snr0sstvpde05cp FOREIGN KEY (compl_cpe_cpe_id) REFERENCES mitre.cpe(cpe_id);


--
-- Name: cpe_compl_cpe fkg404nw9mh83dlxa9p9eejuxk; Type: FK CONSTRAINT; Schema: mitre; Owner: postgres
--

ALTER TABLE ONLY mitre.cpe_compl_cpe
    ADD CONSTRAINT fkg404nw9mh83dlxa9p9eejuxk FOREIGN KEY (cpe_cpe_id) REFERENCES mitre.cpe(cpe_id);
...
--
-- Name: reference fkj0vetgsx6tckuirqlw14jss27; Type: FK CONSTRAINT; Schema: mitre; Owner: postgres
--

ALTER TABLE ONLY mitre.reference
    ADD CONSTRAINT fkj0vetgsx6tckuirqlw14jss27 FOREIGN KEY (cve_cve_id) REFERENCES mitre.cve(cve_id);
